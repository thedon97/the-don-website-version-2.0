...
.site-splash {
  ...
  background:
    ...
    url("../assets/splash-watch-background.jpeg") center 42% / cover,
    #080706;
  opacity: 1;
  visibility: visible;
...
.site-header {
  ...
  background:
    ...
    url("../assets/diamond-banner.jpg") center 50% / cover;
...
.site-sidebar {
  ...
  background:
    ...
    url("../assets/diamond-banner.jpg") center / cover;
...
.hero {
  ...
  color: white;
  background: linear-gradient(90deg, rgba(0,0,0,.86), rgba(0,0,0,.38)), url("../assets/don-logo.jpg") center / cover;
}
.hero::after {
  content: "";
  position: absolute;
